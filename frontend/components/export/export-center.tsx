...
export function ExportCenter() {
  ...
  const dataTypes = [
    { value: "action-plans", label: "Action Plans", icon: FileText },
    { value: "reports", label: "Quarterly Reports", icon: BarChart3 },
    { value: "stakeholders", label: "Stakeholder Data", icon: Users },
    { value: "kpis", label: "KPI Data", icon: Table },
  ]
